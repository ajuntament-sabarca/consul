...
es:
  pages:
    ...
    more_information:
      ...
      how_it_works:
        ...
        text: |-
          ...
          **II. Transparencia:** En este espacio se publicarán todos los datos relativos a quién y cómo se gestiona Sant Andreu de la Barca (nombres de los responsables, cargos, sueldos, planes de gobierno, contratos, agendas de los responsables...). Además es el espacio donde ejercer el derecho de acceso a la información, pudiendo solicitar cualquier información sobre el Ayuntamiento de Sant Andreu de la Barca de manera fácil y rápida.
          **III. Datos Abiertos:** En este espacio se cuelgan las bases de datos que tiene el Ayuntamiento, para que cualquiera pueda usar toda la información directamente, sin necesidad ni siquiera de preguntar. También se puede solicitar la publicación de más bases de datos.
          ...
          Cada uno de los trabajadores del Ayuntamiento tiene un usuario propio, que será resaltado como tal, permitiendo que participen en los debates al mismo nivel que todos los demás ciudadanos. Esto permitirá crear espacios de comunicación directos entre unos y otros, evitando los inconvenientes que implica la comunicación medidada, y respondiendo a un planteamiento claro por parte del nuevo gobierno de Sant Andreu de la Barca por el cual el Ayuntamiento trabaja para la ciudadanía, y ante ella debe responder.
          ...
          Las propuestas pueden ser apoyadas por ciudadanos empadronados en Sant Andreu de la Barca que hayan verificado su cuenta en la plataforma de participación, de tal manera que será la propia ciudadanía, y nadie en su nombre, la que decida cuáles son las propuestas que merecen la pena ser llevadas a cabo.

          Una vez que una propuesta alcance una cantidad de apoyos equivalente al 2% del censo de Sant Andreu de la Barca (unos 53000), automaticamente pasa a ser estudiada por un grupo de trabajo del Ayuntamiento y pasará a la siguiente fase de consulta popular, en la que la ciudadanía de Sant Andreu de la Barca votará si se lleva a cabo o no. El plazo máximo para recabar los apoyos necesarios será de 12 meses.
      how_to_use:
        text: |-
      ...
      titles:
        ...
        participation: Participación y Transparencia en Sant Andreu de la Barca - Próximas novedades
    ...
    opendata:
      go_old: Ir al Portal de Datos Abiertos
    ...
    while_unfinished_html: Mientras acabamos el nuevo portal, te invitamos a visitar el <a href="/blog" target="_blank" title="(se abre en ventana nueva)">blog del Área de Participación Ciudadana, Transparencia y Gobierno Abierto</a> para conocer nuestros avances y novedades; o la <a href="/">sección de Participación Ciudadana</a> donde poder decidir qué ciudad es la que quieres.
